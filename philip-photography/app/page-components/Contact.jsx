...
export default function Contact() {
  const { scale, isFitNeeded } = useViewportScale(850, 0.8)
  return (
    <main className="min-h-screen bg-[rgb(var(--bg))] transition-colors duration-300">
      <div
        className="container-responsive pt-16 xs:pt-18 sm:pt-20 md:pt-22 lg:pt-24 xl:pt-26 2xl:pt-28 pb-6 xs:pb-8 sm:pb-10 md:pb-12 lg:pb-14 xl:pb-16"
      >
        <div
