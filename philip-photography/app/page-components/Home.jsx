...
import { getImagesFromFolder } from '@/src/firebase/storage'
import { getFeaturedImages } from '@/src/firebase/admin-api'
...
export default function Home() {
  ...
  const { scale, isFitNeeded } = useViewportScale(900, 0.75) // Base height 900px, min scale 0.75
  ...
  return (
    <>
      ...
      <section id="home" className="snap-start min-h-screen relative w-full overflow-x-hidden bg-black">
        <div className="relative h-dvh overflow-hidden group">
          ...
          <div
            ...
            style={{ transform: isFitNeeded ? `scale(${scale})` : 'none', transformOrigin: 'center center' }}
          >
      ...
      <section id="about" className="snap-start h-screen flex items-center bg-[rgb(var(--bg))] relative overflow-hidden">
        ...
        <div
          className="container-responsive w-full relative z-10"
          style={{ transform: isFitNeeded ? `scale(${scale})` : 'none', transformOrigin: 'center center' }}
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-left order-2 lg:order-1">
              <FadeInWhenVisible>
                ...
                <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-2 sm:mb-6 text-[rgb(var(--fg))]">
                  {content.about?.title || "John Philip Morada"}
                </h2>

                <p className="text-sm sm:text-base md:text-lg text-[rgb(var(--muted-fg))] leading-relaxed mb-6 sm:mb-8 max-w-2xl font-light">
              ...
              <div className="hidden sm:grid sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-10">
                <FadeInWhenVisible delay={200}>
                  <div className="group p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-md dark:shadow-sm hover:shadow-lg dark:hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    ...
                    <h4 className="font-heading text-sm sm:text-base font-bold mb-1.5 sm:mb-2 text-[rgb(var(--fg))]">{content.about?.philosophy?.title || "My Philosophy"}</h4>
                    <p className="text-[10px] sm:text-xs text-[rgb(var(--fg))] dark:text-[rgb(var(--muted-fg))] leading-relaxed opacity-80 dark:opacity-100">
                ...
                <FadeInWhenVisible delay={400}>
                  <div className="group p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-md dark:shadow-sm hover:shadow-lg dark:hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    ...
                    <h4 className="font-heading text-sm sm:text-base font-bold mb-1.5 sm:mb-2 text-[rgb(var(--fg))]">{content.about?.approach?.title || "My Approach"}</h4>
                    <p className="text-[10px] sm:text-xs text-[rgb(var(--fg))] dark:text-[rgb(var(--muted-fg))] leading-relaxed opacity-80 dark:opacity-100">
              ...
              <FadeInWhenVisible delay={600}>
                <Link href="/about" className="inline-flex items-center gap-2 text-[rgb(var(--primary))] text-sm font-semibold hover:gap-4 transition-all duration-300 group">
                  Read Full Bio
            ...
            {/* Image Column */}
            <div className="lg:col-span-5 relative order-1 lg:order-2 mb-6 sm:mb-8 lg:mb-0 flex items-center justify-center">
              <FadeInWhenVisible delay={300} className="relative z-10 w-full">
                <div className="relative aspect-[3/4] max-w-[240px] sm:max-w-md mx-auto lg:max-w-full lg:max-h-[60vh] transition-transform duration-500 ease-out">
      ...
      <section id="experience" className="snap-start h-screen flex flex-col items-center justify-center bg-[rgb(var(--bg))] relative">
        <div
        ...
        >
          ...
          <div className="mb-6 sm:mb-8 lg:mb-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10 items-start">
              ...
              <div className="lg:col-span-5 space-y-3 sm:space-y-6 lg:space-y-6 sticky top-20 sm:top-32">
                <FadeInWhenVisible>
                  ...
                  <h2 className="font-heading text-2xl sm:text-3xl md:text-3xl lg:text-3xl font-bold leading-tight text-[rgb(var(--fg))] mb-2 sm:mb-3">
                  ...
                  <p className="text-[rgb(var(--muted-fg))] leading-relaxed text-xs sm:text-sm md:text-sm lg:max-w-md">
                ...
                <FadeInWhenVisible delay={200}>
                  ...
                  <div className="hidden sm:flex items-center justify-evenly py-4 sm:py-6 lg:py-6 border-y border-[rgb(var(--muted))]/20">
                    <div className="text-center">
                      <div className="text-2xl sm:text-3xl lg:text-3xl font-bold text-[rgb(var(--fg))] mb-1">{content.experience?.stats?.years || "10"}<span className="text-[rgb(var(--primary))]">+</span></div>
                    ...
                    <div className="text-center">
                      <div className="text-2xl sm:text-3xl lg:text-3xl font-bold text-[rgb(var(--fg))] mb-1">{content.experience?.stats?.count || "500"}<span className="text-[rgb(var(--primary))]">+</span></div>
              ...
              <div className="lg:col-span-7 relative">
                <FadeInWhenVisible delay={300}>
                  {featuredLoading ? (
                    <div className="flex items-center justify-center aspect-video bg-[rgb(var(--muted))]/5 rounded-3xl border border-[rgb(var(--muted))]/20">
                      <div className="text-center">
                    ...
                    >
                      {(() => {
                        ...
                        const containerClass = featuredImage.isPortrait
                          ? 'aspect-[3/4] max-w-[180px] sm:max-w-sm lg:max-h-[50vh] mx-auto'
                          : 'aspect-video w-full lg:max-h-[55vh] lg:max-w-[calc(55vh*1.777)] mx-auto sm:mx-0'

                        return (
                          <div className={`relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] ${containerClass} lg:mt-4`}>
          ...
          <FadeInWhenVisible delay={500}>
            <div className="relative w-full overflow-hidden mt-6 sm:mt-6 lg:mt-8">
      ...
      <section id="contact" className="snap-start h-screen flex items-center bg-[rgb(var(--bg))] relative overflow-hidden">
        {/* Background gradient */}
          ...
          <FadeInWhenVisible>
            <div className="text-center max-w-4xl mx-auto px-4">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <h4 className="font-heading text-fluid-display font-bold text-[rgb(var(--fg))] mb-4 sm:mb-6 lg:mb-8 leading-tight">
      ...
      <footer id="footer" className="snap-start bg-[rgb(var(--bg))] border-t border-[rgb(var(--muted))]/10 py-12 sm:py-16 md:py-20 flex items-center">
