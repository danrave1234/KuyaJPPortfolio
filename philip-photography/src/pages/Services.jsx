        ...
        <div className="container-responsive pt-20 sm:pt-24 md:pt-20 lg:pt-24 pb-8 sm:pb-12">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 border border-[rgb(var(--muted))]/20 rounded-2xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-[rgb(var(--primary))]">01</div>
                    <div className="text-xs text-[rgb(var(--muted))] uppercase tracking-wider">Service</div>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-[rgb(var(--fg))] mb-4">Editorial Photography</h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Species identification photography</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Behavioral documentation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">High-resolution deliverables</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 border border-[rgb(var(--muted))]/20 rounded-2xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-[rgb(var(--primary))]">02</div>
                    <div className="text-xs text-[rgb(var(--muted))] uppercase tracking-wider">Service</div>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-[rgb(var(--fg))] mb-4">Conservation Projects</h3>
                <p className="text-sm text-[rgb(var(--muted-fg))] mb-6 leading-relaxed">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Species monitoring documentation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Habitat assessment photography</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">NGO collaboration</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative p-8 border border-[rgb(var(--muted))]/20 rounded-2xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-[rgb(var(--primary))]">03</div>
                    <div className="text-xs text-[rgb(var(--muted))] uppercase tracking-wider">Service</div>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-[rgb(var(--fg))] mb-4">Workshops & Training</h3>
                <p className="text-sm text-[rgb(var(--muted-fg))] mb-6 leading-relaxed">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Fieldcraft techniques</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Ethical wildlife photography</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-[rgb(var(--primary))] rounded-full"></div>
                    <span className="text-sm text-[rgb(var(--muted-fg))]">Small group sessions</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mt-20 sm:mt-24">
            <div className="text-center mb-12">
              <h3 className="text-lg sm:text-xl font-semibold text-[rgb(var(--fg))] mb-4">Service Coverage</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 border border-[rgb(var(--muted))]/20 rounded-xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                ...
                <h4 className="font-semibold text-[rgb(var(--fg))] mb-2">Primary Coverage</h4>
                <p className="text-sm text-[rgb(var(--muted-fg))]">Batangas, Metro Manila, Southern Luzon</p>
              </div>
              ...
              <div className="text-center p-6 border border-[rgb(var(--muted))]/20 rounded-xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                ...
                <h4 className="font-semibold text-[rgb(var(--fg))] mb-2">Nationwide</h4>
                <p className="text-sm text-[rgb(var(--muted-fg))]">Available across the Philippines</p>
              </div>
              ...
              <div className="text-center p-6 border border-[rgb(var(--muted))]/20 rounded-xl hover:border-[rgb(var(--primary))]/30 transition-all duration-300">
                ...
                <h4 className="font-semibold text-[rgb(var(--fg))] mb-2">International</h4>
                <p className="text-sm text-[rgb(var(--muted-fg))]">Conservation projects worldwide</p>
              </div>
            </div>
          </section>
          ...
          <div className="mt-20 sm:mt-24">
            <div className="bg-gradient-to-r from-[rgb(var(--primary))]/5 to-[rgb(var(--primary))]/10 rounded-2xl p-8 sm:p-12 text-center border border-[rgb(var(--primary))]/20">
              <h3 className="text-xl sm:text-2xl font-bold text-[rgb(var(--fg))] mb-4">Ready to Work Together?</h3>
              <p className="text-sm sm:text-base text-[rgb(var(--muted-fg))] mb-8 max-w-2xl mx-auto">
              ...
              <a 
                href="/contact" 
                className="inline-block px-8 py-4 bg-[rgb(var(--primary))] text-white rounded-lg hover:bg-[rgb(var(--primary))]/90 transition-all duration-300 font-medium transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Get in Touch
              </a>
            </div>
